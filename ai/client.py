...
class AIClient:
    ...
    def read_prompt(filename: str) -> str:
        """Reads a prompt template file from the engine/ai/prompts subdirectory."""
        current_dir = os.path.dirname(os.path.abspath(__file__))
        # current_dir will be root/ai/
        # prompts are in root/engine/ai/prompts/
        path = os.path.join(os.path.dirname(current_dir), "engine", "ai", "prompts", filename)
