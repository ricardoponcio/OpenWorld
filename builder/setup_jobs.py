...
def setup_jobs():
    ...
    for loc_id, nome, tipo in locais:
        nome_low = nome.lower()
        cat = 'generic'
        if 'fazenda' in nome_low or 'campo' in nome_low: cat = 'fazenda'
        elif 'quartel' in nome_low or 'guarda' in nome_low: cat = 'quartel'
        elif 'taverna' in nome_low or 'bar' in nome_low or 'dragão' in nome_low: cat = 'taverna'
        elif 'escola' in nome_low: cat = 'escola'
