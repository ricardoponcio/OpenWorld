/**
 * F01/F05/P01/P04 (docs/16_PLANO_PAINEL_E_IA.md): ponto de entrada único do
 ...
 * painel_npcs.js precisa do próprio `iniciar*` (busca o catálogo de filtros antes
 * de aceitar interação).
 */
