...
> final e o que foi verificado estão na **Frente 5** do [`05_ROADMAP.md`](05_ROADMAP.md). As perguntas
...
>
> Documento de apoio à **Frente 5** do [`05_ROADMAP.md`](05_ROADMAP.md). Este é o design mais em aberto
